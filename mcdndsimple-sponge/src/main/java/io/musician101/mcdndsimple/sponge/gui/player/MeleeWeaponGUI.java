...
public class MeleeWeaponGUI extends SpongeMCDNDSimpleGUI {
    ...
    public MeleeWeaponGUI(@Nonnull MCDNDPlayer mcdndPlayer, int index, @Nonnull Player player) {
        ...
        updatePlusStat();
        setButton(7, SpongeIconBuilder.of(ItemTypes.ENCHANTED_BOOK, Text.of(MenuText.damageBonus(weapon, coreStats))));
        setButton(8, SpongeIconBuilder.of(ItemTypes.DIAMOND, Text.of(MenuText.damageType(weapon.getDamageType()))), ImmutableMap.of(ClickInventoryEvent.Primary.class, p -> new SpongeTextInput(SpongeMCDNDSimple.instance(), p) {
        ...
        setButton(9, SpongeIconBuilder.of(ItemTypes.DIAMOND_SWORD, Text.of(MenuText.critDamage(weapon))), ImmutableMap.of(ClickInventoryEvent.Primary.class, p -> new SpongeTextInput(SpongeMCDNDSimple.instance(), p) {
        ...
        setButton(10, SpongeIconBuilder.of(ItemTypes.GUNPOWDER, Text.of(MenuText.critOn(weapon))), ImmutableMap.of(ClickInventoryEvent.Primary.class, p -> new SpongeTextInput(SpongeMCDNDSimple.instance(), p) {
        ...
        setButton(11, SpongeIconBuilder.of(ItemTypes.REDSTONE_LAMP, Text.of(MenuText.ROLL_ATTACK)), ImmutableMap.of(ClickInventoryEvent.Primary.class, p -> {
            ...
            objects.add(p.getName() + " (as " + mcdndPlayer.getBioAndInfo().getName() + ") meleed with " + weapon.getName() + "." + newLine + "Attack: ");
            ...
            objects.add((secondAttackRoll + bonus)+ " vs AC" + newLine + "Damage: " + Dice.total(weapon.getDamage().roll(), weapon.getDamageBonus(coreStats) + Dice.total(meleeBonus.getDamage().roll())) + " " + weapon.getDamageType());
            if (firstAttackRoll >= weapon.getCritMin()) {
        ...
        setButton(17, SpongeIconBuilder.of(ItemTypes.BARRIER, Text.of(MenuText.BACK)), ImmutableMap.of(ClickInventoryEvent.Primary.class, p -> new MeleeWeaponsGUI(mcdndPlayer, p)));
    }
    ...
    private void updatePlusStat() {
        setButton(6, SpongeIconBuilder.builder(ItemTypes.GLOWSTONE).name(Text.of(MenuText.PLUS_STAT)).addGlow(weapon.plusStat()).build(), ImmutableMap.of(ClickInventoryEvent.Primary.class, p -> {
