...
public class MeleeWeaponGUI extends MCDNDSimpleChestGUI {
    ...
    public MeleeWeaponGUI(Player player, MeleeWeapon weapon, BioAndInfo bioAndInfo, ClassLevels classLevels, CoreStats coreStats, Experience experience, MeleeBonus meleeBonus, AbstractSpongeChestGUI<AbstractConfig, SpongeMCDNDSimple> prevGUI) {
        super(player, weapon.getName(), 18, prevGUI);
        this.weapon = weapon;
