...
public class SpellcastingBonusGUI extends SpigotMCDNDSimpleGUI {
    ...
    public SpellcastingBonusGUI(@Nonnull MCDNDPlayer mcdndPlayer, @Nonnull Player player) {
        ...
        setButton(2, SpigotIconBuilder.builder(Material.POTION).potionEffect(PotionType.LUCK).name(MenuText.SAVE_DC_ROLLS).build(), ImmutableMap.of(ClickType.LEFT, p -> new SpigotTextInput(SpigotMCDNDSimple.instance(), p) {
