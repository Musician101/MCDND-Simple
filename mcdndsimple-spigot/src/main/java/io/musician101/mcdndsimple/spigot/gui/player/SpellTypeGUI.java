...
public class SpellTypeGUI extends SpigotMCDNDSimpleGUI {
    ...
    private void updateSlots() {
        ...
        IntStream.of(0, 45).forEach(x -> {
            try {
                ...
                ItemStack itemStack = SpigotIconBuilder.builder(Material.END_CRYSTAL).name((spell.getSpellType() == spellType ? ChatColor.GREEN : ChatColor.RED) + spellType.getName()).addGlow().build();
