...
public final class SpigotChestGUIs extends ChestGUIs<SpigotChestGUIBuilder<SpigotMCDNDSimple>, ClickType, SpigotChestGUI<SpigotMCDNDSimple>, Inventory, SpigotMCDNDSimple, Player, ItemStack, String> {

    public static final ChestGUIs<SpigotChestGUIBuilder<SpigotMCDNDSimple>, ClickType, SpigotChestGUI<SpigotMCDNDSimple>, Inventory, SpigotMCDNDSimple, Player, ItemStack, String> INSTANCE = new SpigotChestGUIs();
    ...
    public void backgroundTab(@Nonnull Player player, @Nonnull BackgroundTab backgroundTab, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        builder(27, 26, MenuText.BACKGROUND, player, prevGUI).setButtons(GUIButton.of(0, ClickType.LEFT, SpigotIconBuilder.of(Material.ARROW, MenuText.gender(backgroundTab)), (g, p) -> new StringAnvilGUI(p, (ply, s) -> {
            ...
            g.open();
        })), GUIButton.of(8, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.KNOWN_LANGUAGES), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.KNOWN_LANGUAGES, backgroundTab.getLanguages()), pages -> {
            ...
            g.open();
        })), GUIButton.of(10, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.BACKGROUND), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.BACKGROUND, backgroundTab.getBackground()), pages -> {
            backgroundTab.setBackground(pages);
            g.open();
        })), GUIButton.of(11, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.RACIAL_TRAITS), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.RACIAL_TRAITS, backgroundTab.getRacialTraits()), pages -> {
            backgroundTab.setRacialTraits(pages);
            g.open();
        })), GUIButton.of(12, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.PERSONALITY_TRAITS), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.PERSONALITY_TRAITS, backgroundTab.getPersonalityTraits()), pages -> {
            backgroundTab.setPersonalityTraits(pages);
            g.open();
        })), GUIButton.of(13, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.IDEALS), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.IDEALS, backgroundTab.getIdeals()), pages -> {
            backgroundTab.setIdeals(pages);
            g.open();
        })), GUIButton.of(14, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.BONDS), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.BONDS, backgroundTab.getBonds()), pages -> {
            backgroundTab.setBonds(pages);
            g.open();
        })), GUIButton.of(15, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.FLAWS), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.FLAWS, backgroundTab.getFlaws()), pages -> {
            backgroundTab.setFlaws(pages);
            g.open();
        })), GUIButton.of(16, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.ARMOR_PROFICIENCIES), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.ARMOR_PROFICIENCIES, backgroundTab.getArmorProficiencies()), pages -> {
            backgroundTab.setArmorProficiencies(pages);
            g.open();
        })), GUIButton.of(17, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.WEAPON_PROFICIENCIES), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.WEAPON_PROFICIENCIES, backgroundTab.getWeaponProficiencies()), pages -> {
            backgroundTab.setWeaponProficiencies(pages);
            g.open();
        })), GUIButton.of(18, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.TOOL_PROFICIENCIES), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.TOOL_PROFICIENCIES, backgroundTab.getToolProficiencies()), pages -> {
            backgroundTab.setToolProficiencies(pages);
            g.open();
        })), GUIButton.of(19, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.OTHER_NOTES), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.OTHER_NOTES, backgroundTab.getOtherNotes()), pages -> {
    ...
    public void bioAndInfo(@Nonnull Player player, @Nonnull BioAndInfo bioAndInfo, @Nonnull PlayerSheet playerSheet, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        builder(9, 8, MenuText.BIO_AND_INFO, player, prevGUI).setButtons(GUIButton.of(0, ClickType.LEFT, SpigotIconBuilder.of(Material.NAME_TAG, MenuText.name(bioAndInfo)), (g, p) -> new StringAnvilGUI(p, (ply, s) -> {
            ...
            g.open();
        })), GUIButton.of(1, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.BIO), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.BIO, bioAndInfo.getBio()), pages -> {
    ...
    @Nonnull
    @Override
    protected SpigotChestGUIBuilder<SpigotMCDNDSimple> builder(int size, int backButtonSlot, @Nonnull String name, @Nonnull Player player, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
    ...
    public void classTab(@Nonnull Player player, @Nonnull ClassTab classTab, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        builder(9, 8, MenuText.CLASS, player, prevGUI).setButtons(GUIButton.of(0, ClickType.LEFT, SpigotIconBuilder.of(Material.ENCHANTED_BOOK, MenuText.CLASS_LEVELS), (g, p) -> classLevels(p, classTab.getClassLevels(), g)), GUIButton.of(1, ClickType.LEFT, SpigotIconBuilder.of(Material.DIAMOND, MenuText.CLASS_RESOURCES), (g, p) -> classResources(p, classTab.getClassResources(), 1, g)), GUIButton.of(2, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.CLASS_FEATURE_NOTES), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.CLASS_FEATURE_NOTES, classTab.getClassFeatureNotes()), pages -> {
            classTab.setClassFeatureNotes(pages);
            classTab(p, classTab, prevGUI);
        })), GUIButton.of(3, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.OTHER_NOTES), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.OTHER_NOTES, classTab.getOtherNotes()), pages -> {
    ...
    public void item(@Nonnull Player player, @Nonnull MCDNDItem item, @Nonnull List<MCDNDItem> items, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        builder(9, 8, item.getName(), player, prevGUI).setButtons(GUIButton.of(0, ClickType.LEFT, SpigotIconBuilder.of(Material.PAPER, MenuText.RENAME), (g, p) -> new StringAnvilGUI(p, (ply, s) -> {
            ...
            item.setWeight(d);
            item(player, item, items, prevGUI);
        })), GUIButton.of(4, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.DESCRIPTION), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, item.getName(), item.getDescription()), pages -> {
    ...
    public void nonPlayer(@Nonnull Player player, @Nonnull NonPlayer nonPlayer, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        ...
        if (player.hasPermission(Permissions.DM)) {
            builder.setButtons(GUIButton.of(6, ClickType.LEFT, SpigotIconBuilder.builder(Material.SKULL_ITEM).name(MenuText.EDIT_CONTROLLERS).durability(3).build(), (g, p) -> editControllers(p, 1, nonPlayer, g)), GUIButton.of(7, ClickType.LEFT, SpigotIconBuilder.of(Material.ENDER_CHEST, MenuText.DELETE), (g, p) -> SpigotMCDNDSimple.instance().getNonPlayerSheetStorage().remove(nonPlayer)));
        }
    ...
    public void nonPlayerAction(@Nonnull Player player, @Nonnull NonPlayerAction nonPlayerAction, @Nonnull List<NonPlayerAction> nonPlayerActions, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        ...
        })), GUIButton.of(1, ClickType.LEFT, SpigotIconBuilder.of(Material.IRON_SWORD, MenuText.actionType(nonPlayerAction.getActionType())), (g, p) -> nonPlayerActionType(p, 1, nonPlayerAction, nonPlayerActions, g)), GUIButton.of(2, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.DESCRIPTION), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, nonPlayerAction.getName(), nonPlayerAction.getDescription()), pages -> {
            nonPlayerAction.setDescription(pages);
            g.open();
        })), GUIButton.of(3, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.EFFECT), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, nonPlayerAction.getName(), nonPlayerAction.getEffect()), pages -> {
    ...
    @Nonnull
    @Override
    protected <O> SpigotChestGUIBuilder<SpigotMCDNDSimple> paged(@Nonnull String name, @Nonnull Player player, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI, int page, @Nonnull Function<O, ItemStack> itemStackMapper, @Nullable Function<O, BiConsumer<SpigotChestGUI<SpigotMCDNDSimple>, Player>> actionMapper, @Nonnull BiConsumer<Player, Integer> pageNavigator, @Nonnull List<O> contents) {
    ...
    @Override
    public void skillsTab(@Nonnull Player player, @Nonnull BioAndInfo bioAndInfo, @Nonnull ClassLevels classLevels, @Nonnull CoreStats<PlayerAbilityScore> coreStats, @Nonnull Dice skillBonus, @Nonnull Experience experience, @Nonnull SkillsTab skillsTab, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
    ...
    public void spell(@Nonnull Player player, @Nonnull Spell spell, @Nonnull BioAndInfo bioAndInfo, @Nonnull ClassLevels classLevels, @Nonnull CoreStats coreStats, @Nonnull Experience experience, @Nonnull SpellcastingBonus spellcastingBonus, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        SpigotChestGUIBuilder<SpigotMCDNDSimple> builder = builder(27, 26, spell.getName(), player, prevGUI).setButtons(GUIButton.of(0, ClickType.LEFT, SpigotIconBuilder.of(Material.PAPER, MenuText.RENAME), (g, p) -> new StringAnvilGUI(p, (ply, s) -> {
            ...
            spell.setDuration(s);
            spell(ply, spell, bioAndInfo, classLevels, coreStats, experience, spellcastingBonus, prevGUI);
        })), GUIButton.of(11, ClickType.LEFT, SpigotIconBuilder.builder(Material.PURPLE_SHULKER_BOX).name(MenuText.COMPONENTS).description(spell.getComponents()).build(), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, spell.getName(), spell.getComponents()), pages -> {
    ...
    public void spellDescription(@Nonnull Player player, @Nonnull Spell spell, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        builder(9, 8, MenuText.DESCRIPTION, player, prevGUI).setButtons(GUIButton.of(0, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.DESCRIPTION), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, spell.getName(), spell.getDescription()), pages -> {
            spell.setDescription(pages);
            g.open();
        })), GUIButton.of(1, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.AT_HIGHER_LEVELS), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, spell.getName(), spell.getAtHigherLevels()), pages -> {
    ...
    public void spellSave(@Nonnull Player player, @Nonnull SpellSave spellSave, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        ...
        })), GUIButton.of(3, ClickType.LEFT, SpigotIconBuilder.of(Material.BOOK, MenuText.ON_SUCCESSFUL_SAVE), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.ON_SUCCESSFUL_SAVE, spellSave.getOnSuccessfulSave()), spellSave::setOnSuccessfulSave))).build();
    }
    ...
    public void traitsBackground(@Nonnull Player player, @Nonnull TraitsBackground traitsBackground, @Nullable SpigotChestGUI<SpigotMCDNDSimple> prevGUI) {
        builder(9, 8, MenuText.TRAITS_BACKGROUND, player, prevGUI).setButtons(GUIButton.of(0, ClickType.LEFT, SpigotIconBuilder.builder(Material.MILK_BUCKET).name(MenuText.CONDITION_IMMUNITY).description(traitsBackground.getConditionImmunity()).build(), (g, p) -> new StringAnvilGUI(p, (ply, s) -> {
            ...
            traitsBackground(ply, traitsBackground, prevGUI);
        })), GUIButton.of(4, ClickType.LEFT, SpigotIconBuilder.builder(Material.SHIELD).name(MenuText.TRAITS).description(traitsBackground.getDamageResistance()).build(), (g, p) -> new SpigotBookGUI<>(SpigotMCDNDSimple.instance(), p, createBook(p, MenuText.TRAITS, traitsBackground.getTraits()), pages -> {
