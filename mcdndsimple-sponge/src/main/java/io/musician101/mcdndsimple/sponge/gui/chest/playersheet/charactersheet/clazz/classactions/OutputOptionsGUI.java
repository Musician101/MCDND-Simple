...
public class OutputOptionsGUI extends MCDNDSimpleChestGUI {
    ...
    protected void build() {
        ...
        set(1, ClickInventoryEvent.class, createItem(ItemTypes.GOLD_INGOT, Text.of(MenuText.WEAPONS_SPELL_MISC)), player -> new WeaponsSpellMiscOutputOptionsGUI(player, outputOptions.getWeaponsSpellMiscOutputOptions(), this));
        set(2, ClickInventoryEvent.class, createItem(ItemTypes.NETHER_STAR, Text.of(MenuText.CORE_SKILLS)), player -> new CoreSkillsOutputOptionsGUI(player, outputOptions.getCoreSkillsOutputOptions(), this));
