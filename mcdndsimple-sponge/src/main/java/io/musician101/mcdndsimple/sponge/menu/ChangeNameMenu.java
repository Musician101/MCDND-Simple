...
public class ChangeNameMenu extends AbstractSpongeMenu {
    ...
    public ChangeNameMenu() {
        super(SpongeMCDNDSimple.getPluginContainer(), (OrderedInventory) Sponge.getRegistry().createBuilder(Builder.class).of(InventoryArchetypes.ANVIL).build(SpongeMCDNDSimple.instance()), event -> {
