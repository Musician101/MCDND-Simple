...
public class Reference {
    ...
    public static class MenuText {
        ...
        public static String[] experience(Experience experience, ClassLevels classLevels) {
            return new String[]{overallLevel(experience, classLevels), proficiencyBonus(experience, classLevels),
                    currentXP(experience), xpForNextLevel(experience, classLevels)};
        }
