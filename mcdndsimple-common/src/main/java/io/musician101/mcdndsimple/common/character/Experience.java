...
public class Experience
{
    ...
    public int getXPForNextLevel(ClassLevels classLevels)
    {
        return ImmutableMap.<Integer, Integer>builder()
                ...
                .get(getOverallLevel(classLevels));
    }
    ...
    {
        return classLevels.getBarbarian() + classLevels.getBard() + classLevels.getCleric() + classLevels.getDruid() +
                classLevels.getFighter() + classLevels.getMonk() + classLevels.getPaladin() + classLevels.getRanger() +
                classLevels.getRogue() + classLevels.getSorcerer() + classLevels.getWarlock() + classLevels.getWizard();
    }
    ...
    public int getProficiencyBonus(ClassLevels classLevels)
    {
        return ImmutableMap.<Integer, Integer>builder()
                ...
                .put(20, 6).build().get(getOverallLevel(classLevels));
    }
